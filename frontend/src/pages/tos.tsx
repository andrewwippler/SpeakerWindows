  ...
  return (
    <Layout>
      <div className="space-y-4 text-gray-600">
        <div className="grid grib-cols-1 text-xl font-bold pt-8 text-sky-900">
          <span className="mr-4 col-span-6">SpeakerWindows Terms of Use</span>
          <span className="text-sm">Last updated: 2023-Mar-27</span>
        </div>
        <p>
          Welcome to the SpeakerWindow&apos;s Terms of Use agreement. For
          purposes of this agreement, “Site” refers to the Company&apos;s
          website, which can be accessed at{" "}
          <Link className="underline" href="/">
            https://sw.wplr.rocks
          </Link>{" "}
          or through our mobile application. “Service” refers to the Company’s
          services accessed via the Site, in which users can store and retrieve
          personal illustrations, attachments, tags, and places where these are
          used. The terms “we,” “us,” and “our” refer to the Company. “You”
        ...
        <p>
          ...
          or by accessing the Service through clicking on the application (the
        ...
        <p>
          ...
          <Link className="underline" href="/privacy-policy">
            https://sw.wplr.rocks/privacy-policy
          </Link>
        ...
        <p>
          The Service allows you to store and retrieve personal illustrations,
          attachments, tags, and places where these are used. Personal
          illustrations are what you enter and may or may not contain sensitive
          information.
        </p>
        ...
        <p>
          You need to be at least 13 years old and reside in a country which
          allows you to form a legal agreement to register for and use the
          Service.
        </p>
        <p>
          ...
          to access the Service and to receive messages from the Company. You
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            ...
            indices but retain the right to revoke this permission at any time
            on a general or specific basis);
          </li>
          <li>
        ...
        <p>
          ...
          provide illustrations and media (“User Content”) to the Service. You
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            ...
            perform that Content in connection with the provision of the
            ...
            derivative works of, display and perform such Content to the extent
        ...
        <p>
          ...
          Site or the Service or to limit or deny a user’s access to the Service
          or take other appropriate action if a user violates these Terms of Use
          or engages in any activity that violates the rights of any person or
          entity or which we deem unlawful, offensive, abusive, harmful or
          malicious. E-mails sent between you and other participants that are
          ...
          have the right to remove any material that in its sole opinion
          ...
          threaten the safety of users or others. Unauthorized use may result in
          criminal and/or civil prosecution under Federal, State and local law.
          If you become aware of a misuse of our Service or violation of these
          Terms of Use, please contact us using our form at{" "}
          <Link className="underline" href="/contact">
            https://sw.wplr.rocks/contact
          </Link>
          .
        </p>
        ...
        <p>
          ...
          approval or endorsement. If you decide to leave the Site and access
          ...
          policies, including privacy and data gathering practices, of any Third
          Party Site to which you navigate from the Site or relating to any
        ...
        <p>
          ...
          designated copyright agent using the form at{" "}
          <Link className="underline" href="/contact">
            https://sw.wplr.rocks/contact
          </Link>
          :
        ...
        <ul className="list-inside list-decimal">
          ...
          <li>
            ...
            removed as a result of mistake or a misidentification of the
            content; and
          </li>
        </ul>
        <p>
          ...
          such person that it may reinstate the removed content in ten (10)
          ...
          content may (in our sole discretion) be reinstated on the Site in ten
          (10) to fourteen (14) business days or more after receipt of the
          counter-notice.
        </p>

        <div className="text-xl font-bold pt-8 text-sky-900">LICENSE GRANT</div>
        <p>
        ...
        <p>
          ...
          reserve all rights that are not expressly granted to you under these
          Terms of Use.
        </p>
        ...
        <p>
          ...
          settings, using the “Unsubscribe” link in the message.
        </p>
        <p>
        ...
        <p>
          ...
          WITHOUT LIMITING THE FOREGOING, WE EXPRESSLY DISCLAIM ALL WARRANTIES,
          ...
          WITHOUT LIMITING THE FOREGOING, WE MAKE NO WARRANTY OR REPRESENTATION
          THAT ACCESS TO OR OPERATION OF THE SERVICE WILL BE UNINTERRUPTED OR
          ...
          OTHER MATERIAL OBTAINED FROM THE SERVICE. SOME JURISDICTIONS LIMIT OR
          DO NOT PERMIT DISCLAIMERS OF WARRANTY, SO THIS PROVISION MAY NOT APPLY
          TO YOU.
        </p>
        <div className="text-xl font-bold pt-8 text-sky-900">
        ...
        <p>
          ...
          OR PARTNERS, BE LIABLE TO YOU FOR ANY LOSS OF PROFITS, USE, OR DATA,
          ...
          MAKE THE SERVICE AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH USE OR
          WITH ANY OTHER USER OF THE SERVICE, WHETHER BASED ON WARRANTY,
          ...
          OF ITS ESSENTIAL PURPOSE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT
        ...
        <p>
          ...
          specifically waive California Civil Code §1542, which says: “A general
        ...
        <div className="text-xl font-bold pt-8 text-sky-900">GENERAL TERMS</div>
        ...
        <p>
          ...
          federal laws of the United States of America without regard to
        ...
        <p>
          ...
          POLICY AT https://sw.wplr.rocks/privacy-policy REPRESENT THE COMPLETE
