  ...
  return (
    <Layout>
      <div className="space-y-4 text-gray-600">
        ...
        <p>
          SpeakerWindows (the “Company”) is committed to maintaining robust
        ...
        <p>
          ...
          refers to you, as a user of our Site or our Service. By accessing our
          Site or our Service, you accept our Privacy Policy and Terms of Use
          (found here:{" "}
          <Link className="underline" href="/tos">
            https://sw.wplr.rocks/tos
          </Link>
        ...
        <p>
          ...
          Information includes your email, which you submit to us through the
        ...
        <p>
          ...
          thereafter, you may not need to submit further Personal
          Information,which may include: details revealed in your personal
          illustrations. However, in an effort to improve the quality of the
          ...
          small text files which include an anonymous unique identifier. Cookies
          are sent to a user’s browser from our servers and are stored on the
          ...
          keep a record of the user’s preferences when utilizing our services,
          both on an individual and aggregate basis. For example, the Company
        ...
        <p>
          ...
          information, please contact us on our form at{" "}
        ...
        <p>
          ...
          marketing communications from us by filling out the contact form at{" "}
          <Link className="underline" href="/contact">
            https://sw.wplr.rocks/contact
          </Link>
          . Please note that notwithstanding the promotional preferences you
          indicate by either unsubscribing or opting out from the form at{" "}
          <Link className="underline" href="/contact">
            https://sw.wplr.rocks/contact
          </Link>
        ...
        <p>
          ...
          practices of this Site, please contact us through our contact form at{" "}
          <Link className="underline" href="/contact">
            https://sw.wplr.rocks/contact
          </Link>
          .
        ...
        <span className="text-sm">
          Last Updated: This Privacy Policy was last updated on 2023-Mar-27.
        </span>
      </div>
    </Layout>
  );
