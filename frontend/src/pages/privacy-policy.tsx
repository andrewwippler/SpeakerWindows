  ...
  return (
    <Layout>
      <div className='space-y-4 text-gray-600'>
          ...
          <span className='mr-4 col-span-6'>SpeakerWindows PRIVACY POLICY</span>
        </div>


<p>SpeakerWindows (the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.</p>

<p>For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at <Link className='underline' href='/'>https://sw.wplr.rocks</Link> or through our mobile application. “Service” refers to the Company’s services accessed via the Site, in which users can store and retrieve personal illustrations, attachments, tags, and places where these are used. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service. By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use (found here: <Link className='underline' href='/tos'>https://sw.wplr.rocks/tos</Link>), and you consent to our collection, storage, use and disclosure of your Personal Information as described in this Privacy Policy.
</p>
<div className="text-xl font-bold pt-8 text-sky-900">I. INFORMATION WE COLLECT</div>

<p>We collect “Non-Personal Information” and “Personal Information.” Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit and preferences that are generated based on the data you submit and number of clicks. Personal Information includes your email, which you submit to us through the registration process at the Site.</p>

<div className="text-xl font-bold pt-8 text-sky-900">1.   Information collected via Technology</div>

        <p>To activate the Service you do not need to submit any Personal Information other than your email address. To use the Service thereafter, you may not need to submit further Personal Information,which may include: details revealed in your personal illustrations. However, in an effort to improve the quality of the Service, we track information provided to us by your browser or by our software application when you view or use the Service, such as the website you came from (known as the “referring URL”), the type of browser you use, the device from which you connected to the Service, the time and date of access, and other information that does not personally identify you. We track this information using cookies, or small text files which include an anonymous unique identifier. Cookies are sent to a user’s browser from our servers and are stored on the user’s computer hard drive. Sending a cookie to a user’s browser enables us to collect Non-Personal information about that user and keep a record of the user’s preferences when utilizing our services, both on an individual and aggregate basis. For example, the Company may use cookies to collect the following information:</p>
...
<div className="text-xl font-bold pt-8 text-sky-900">2.   Information you provide us by registering for an account</div>
...
<div className="text-xl font-bold pt-8 text-sky-900">3. Children’s Privacy</div>

<p>The Site and the Service are not directed to anyone under the age of 13. The Site does not knowingly collect or solicit information from anyone under the age of 13, or allow anyone under the age of 13 to sign up for the Service. In the event that we learn that we have gathered personal information from anyone under the age of 13 without the consent of a parent or guardian, we will delete that information as soon as possible. If you believe we have collected such information, please contact us on our form at <Link className='underline' href='/contact'>https://sw.wplr.rocks/contact</Link>.</p>

<div className="text-xl font-bold pt-8 text-sky-900">II. HOW WE USE AND SHARE INFORMATION</div>

<div className='text-sm text-sky-900'>Personal Information:</div>
...
<div className='text-sm text-sky-900'>Non-Personal Information:</div>
...
<div className="text-xl font-bold pt-8 text-sky-900">III. HOW WE PROTECT INFORMATION</div>
...
<div className="text-xl font-bold pt-8 text-sky-900">IV. YOUR RIGHTS REGARDING THE USE OF YOUR PERSONAL INFORMATION</div>

<p>You have the right at any time to prevent us from contacting you for marketing purposes.  When we send a promotional communication to a user, the user can opt out of further promotional communications by following the unsubscribe instructions provided in each promotional e-mail. You can also indicate that you do not wish to receive marketing communications from us by filling out the contact form at <Link className='underline' href='/contact'>https://sw.wplr.rocks/contact</Link>. Please note that notwithstanding the promotional preferences you indicate by either unsubscribing or opting out from the form at <Link className='underline' href='/contact'>https://sw.wplr.rocks/contact</Link>, we may continue to send you administrative emails including, for example, periodic updates to our Privacy Policy.</p>

<div className="text-xl font-bold pt-8 text-sky-900">V. LINKS TO OTHER WEBSITES</div>
...
<div className="text-xl font-bold pt-8 text-sky-900">VI. CHANGES TO OUR PRIVACY POLICY</div>
...
<div className="text-xl font-bold pt-8 text-sky-900">VII. CONTACT US</div>

<p>If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us through our contact form at <Link className='underline' href='/contact'>https://sw.wplr.rocks/contact</Link>.</p>


         <span className='text-sm'>Last Updated: This Privacy Policy was last updated on 2023-Mar-27.</span>
        </div>
    </Layout>
  )
}
