...
export default function Register() {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    api.post(`/register`, form, "").then((data) => {
      ...
      <>
        ...
        >
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block w-full rounded-md border-0 py-1.5 text-sky-900 shadow-sm ring-1 ring-inset ring-sky-300 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                  <p className="text-xs mt-1 ml-1 text-sky-500">
                  ...
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label htmlFor="tos" className="font-medium text-sky-900">
                        ...
                        and{" "}
                        <Link href="/tos" legacyBehavior passHref>
                          <a
                            className="underline"
                            target="_blank"
                            rel="noopener noreferrer"
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            <button
              type="button"
              className="inline-flex items-center text-sm font-semibold leading-6 text-sky-900"
              onClick={() => router.back()}
            >
